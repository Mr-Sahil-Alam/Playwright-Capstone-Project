...
Locator: locator('.product-information span span')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.product-information span span')
...
```ts
  ...
  4  | 
  5  | test('Verify Product Price Visibility', async ({ page }) => {
  6  | 
