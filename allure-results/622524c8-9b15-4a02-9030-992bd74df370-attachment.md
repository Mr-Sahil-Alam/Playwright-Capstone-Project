...
- Name: profile\profileSignupButtonVisible.spec.js >> Verify Signup Button Visible
- Location: tests\profile\profileSignupButtonVisible.spec.js:3:1
...
```ts
  ...
  2  | 
  3  | test('Verify Signup Button Visible', async ({ page }) => {
  4  | 
