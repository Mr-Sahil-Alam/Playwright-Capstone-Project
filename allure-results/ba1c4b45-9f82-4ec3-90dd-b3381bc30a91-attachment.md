...
- Name: payment\paymentNavbarVisible.spec.js >> Verify Header Visible
- Location: tests\payment\paymentNavbarVisible.spec.js:3:1
...
```ts
  ...
  2  | 
  3  | test('Verify Header Visible', async ({ page }) => {
  4  | 
> 5  |     await page.goto(
     |                ^ Error: page.goto: net::ERR_INTERNET_DISCONNECTED at https://automationexercise.com/view_cart
