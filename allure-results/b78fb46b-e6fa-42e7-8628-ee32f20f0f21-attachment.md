...
- Name: cart\cartSubscription.spec.js >> Verify Subscription Section In Cart
- Location: tests\cart\cartSubscription.spec.js:5:1
...
- banner:
  ...
  - text: for more information. 2026-05-23 06:21:38 UTC
- text: You
...
```ts
  ...
  4  | 
  5  | test('Verify Subscription Section In Cart', async ({ page }) => {
  6  | 
