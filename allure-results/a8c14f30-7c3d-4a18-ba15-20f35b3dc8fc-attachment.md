...
Locator: locator('.product-information p').nth(2)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.product-information p').nth(2)
...
- banner:
  ...
  - text: for more information. 2026-05-23 05:29:26 UTC
- text: You
...
```ts
  ...
  4  | 
  5  | test('Verify Product Brand Visibility', async ({ page }) => {
  6  | 
