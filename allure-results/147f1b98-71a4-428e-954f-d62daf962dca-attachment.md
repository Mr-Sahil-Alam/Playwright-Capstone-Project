...
- main:
  ...
  - button:
    - img
  - link "Collections collection cover collection cover collection cover Prismatic Shard Tabletop Terrain":
  ...
  - paragraph
  - link "Collections collection cover Characters":
  ...
  - paragraph
  - link "Collections collection cover Cyborg and Robotic (jurafjvs)":
  ...
  - paragraph
  - link "Collections collection cover Glory to Women (jurafjvs)":
  ...
  - paragraph
  - link "Collections collection cover Relics of the Wasteland":
  ...
  - paragraph
  - link "Collections collection cover High Tech World":
  ...
  - paragraph
  - link "Collections collection cover collection cover collection cover collection cover collection cover collection cover Prefects' Cabinet Collection 🪄":
  ...
  - paragraph
  - link "Collections collection cover collection cover collection cover collection cover collection cover The Enchanted Vault":
  ...
  - paragraph
  - link "Collections collection cover Tabletop 3D Figures":
  ...
  - paragraph
  - link "Collections collection cover collection cover collection cover collection cover collection cover collection cover collection cover collection cover ysprottel's favorites":
