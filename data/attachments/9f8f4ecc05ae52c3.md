...
- Name: contact\contactFooterVisibility.spec.js >> Verify Footer Visible On Contact Page
- Location: tests\contact\contactFooterVisibility.spec.js:3:1
...
```ts
  ...
  2  | 
  3  | test('Verify Footer Visible On Contact Page', async ({ page }) => {
  4  | 
> 5  |     await page.goto('https://automationexercise.com/contact_us');
     |                ^ Error: page.goto: Test timeout of 30000ms exceeded.
  6  | 
  7  |     await expect(
  8  |         page.locator('footer')
  9  |     ).toBeVisible();
  10 | 
  11 | });
```