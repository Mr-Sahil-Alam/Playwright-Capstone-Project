...
- Name: payment\paymentSubscriptionVisible.spec.js >> Verify Subscription Section Visible
- Location: tests\payment\paymentSubscriptionVisible.spec.js:3:1
...
> 5  |     await page.goto(
  ...
  8  | 
  9  |     await expect(
  10 |         page.getByText('Subscription')
  11 |     ).toBeVisible();
  12 | 
  13 | });
```