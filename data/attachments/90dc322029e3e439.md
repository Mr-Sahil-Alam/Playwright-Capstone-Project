...
Expected pattern: /product_details/
Received string:  "https://automationexercise.com/products"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    13 × unexpected value "https://automationexercise.com/products"
...
```ts
  ...
  4  | 
  5  | test('Verify Product Detail Page URL', async ({ page }) => {
  6  | 
