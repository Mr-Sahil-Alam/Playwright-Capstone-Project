...
- Name: shipping\shippingCartNavigation.spec.js >> Verify Navigation To Cart Page
- Location: tests\shipping\shippingCartNavigation.spec.js:3:1
...
```ts
  ...
  2  | 
  3  | test('Verify Navigation To Cart Page', async ({ page }) => {
  4  | 
