        ...
        - generic [ref=f9e6]:
          - generic [ref=f9e8]:
            - link "Google Chrome" [ref=f9e11] [cursor=pointer]:
              - /url: https://googleads.g.doubleclick.net/aclk?sa=l&ai=CBoVzQkocauT9CaSD8LIP8J3UoAyek8_VhgHqiYmvwxWwkB8QASD9tJ6VAWDlgoCA5A6gAY6Q3LEoyAEBqAMByAPLBKoEjQJP0BJt6mCLqnO32LSkIo6DK0NwNhwoVhLn02whMIRrz-c7XvsZtTbM9a6E65G0xywuW4AFOEJj-T9Cp8qc4CbroVrWFb4Mifl4IW75w-jPimWTnL2F93B3qNTHHN1fn6uwhS3vydDY59FEHdRMzeILHAJ-fi8gb-gesZWHxTiESWhZxBSHOTszg8VTCHVPuqZdyHq1VQQ-YSzPddGN-j8zXgG3xKKzJPybjvU4K4pRX5-z-7jmM6_yHoeO5nFiZAYUNRO1q45w6xQgLDgtm_mwdSXDFc6lHSphid0yFNdn7YIdn0zBKF5GzOuC7vbRB1sMrGI7lkCJef7zZhDfqjFGA28B2QedKpSY9XJzUcAE3uqUzNYFiAXDr4qmV4AH44nNIqgHp8yxAqgH4tixAqgHpr4bqAfMzrECqAfz0RuoB5bYG6gHqpuxAqgHjs4bqAeT2BuoB_DgG6gH7paxAqgH_p6xAqgHr76xAqgH1ckbqAfZtrECqAeaBqgH_56xAqgH35-xAqgH-MKxAqgH-8KxAqgHwsixAtgHAdIIMwiAYRABGJ8DMgiKgoCAgICACDoPgECAwICAgICogAKog4AQSL39wTpY74Dg4OLjlANgAZoJKmh0dHBzOi8vd3d3Lmdvb2dsZS5jb20vY2hyb21lL2RyL2Rvd25sb2FkL7EJSy4tBLJWCIKACgHICwHgCwGiDA8qCgoIjt-xApXisQKQAQGqDQJJTsgNAeoNEwiPrODg4uOUAxWkAVwAHfAOFcSIDgnYEwyIFATQFQGYFgHKFgIKAPgWAYAXAbIXBBgBUAa6FwI4AbIYCRIC3mgYASIBANAYAegYAbIZAS_CGQIIAQ&gclid=EAIaIQobChMI5Kbg4OLjlAMVpAFcAB3wDhXEEAEYASAAEgKqdfD_BwE&num=1&cid=CAQSnwIABaugfYNTh8rl7PIQy6wBn9sih1PYlgjlxiKjlYkKwg6Cc2DwHoHNseFK7heH_LNTwe5_17ewhg2l7fuT92tCkqPCepwfNYSK9zICd4ndkQEjUQnJAgOPyNMlesCDL8Q---n3mTp6pMdexjNPPZHrummUmb-Q3eTZxEqoEFttKzndtszRNJBgh3DcoOXS8aP0yqJ-5yobP5_Bm-QGLdJiwqUbNlllpY0a24HC3Mce433VmAzWIfADsDulWO9Q5juNqs1XG0x1VLR_s3P_Bd0pXuPi6_TcAYWVxT7Jz0Xp1L5AtXs0B7Pi6T95O_7P6aEf4eNWyiPiJEOjVrah2ktBR2-sgrNq1RgOk2LqDPIuAYGmxfiWsRLuHHvTP7boyxgB&sig=AOD64_1GQCL80erVvH38GQOxBqsqUONHrw&client=ca-pub-1677597403311019&rf=1&nb=19&adurl=https://ad.doubleclick.net/ddm/trackclk/N5295.5087813DEMANDGEN/B34618049.437475499%3Bdc_trk_aid%3D629327307%3Bdc_trk_cid%3D246757563%3Bdc_lat%3D%3Bdc_rdid%3D%3Btag_for_child_directed_treatment%3D%3Btfua%3D%3Bgdpr%3D%24%7BGDPR%7D%3Bgdpr_consent%3D%24%7BGDPR_CONSENT_755%7D%3Bltd%3D%3Bdc_tdv%3D1%3Bdc_pubid%3D8%3Fgad_source%3D5%26gad_campaignid%3D23433746371
...
> 52 |         await this.page.goto(
  ...
  69 | 
  70 |     await this.emailInput.fill(email);
  71 | 
  72 |     await this.passwordInput.fill(password);
  73 | 
  74 |     await this.loginBtn.click({
  75 |         force: true
  76 |     });
  77 | }
  78 | 
  79 |     async signup(name, email) {
  80 | 
  81 |         await this.signupNameInput.fill(name);
  82 | 
  83 |         await this.signupEmailInput.fill(email);
  84 | 
  85 |         await this.signupBtn.waitFor();
  86 | 
  87 |         await this.signupBtn.scrollIntoViewIfNeeded();
  88 | 
  89 |         await this.signupBtn.click({
  90 |             force: true
  91 |         });
  92 |     }
  93 | 
