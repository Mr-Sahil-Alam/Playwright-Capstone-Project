...
- main:
  ...
  - link "Collections collection cover Verdant Voyager Solar Ember Interceptor Rustbound Juggernaut Verdigris War Engine Dieselpunk Flightworks":
    - /url: /collections/Dieselpunk-Flightworks-019a5b7c-5257-7e09-97f2-c1b7db135d16
    - img
    - img
    - text: Collections
    - img "collection cover"
    - img "Verdant Voyager"
    - img "Solar Ember Interceptor"
    - img "Rustbound Juggernaut"
    - img "Verdigris War Engine"
    - paragraph: Dieselpunk Flightworks
  - img "bitstyler"
  - img
  - paragraph: bitstyler
