...
- Name: checkout\checkoutFooter.spec.js >> Verify Footer Visible On Checkout Page
- Location: tests\checkout\checkoutFooter.spec.js:5:1
...
- banner:
  ...
  - text: for more information. 2026-05-30 04:45:00 UTC
- text: You
...
```ts
  ...
  4  | 
  5  | test('Verify Footer Visible On Checkout Page', async ({ page }) => {
  6  | 
