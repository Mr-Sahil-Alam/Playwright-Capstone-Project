...
- Name: profile\profileUrlValidation.spec.js >> Verify Login Page URL
- Location: tests\profile\profileUrlValidation.spec.js:3:1
...
```ts
  ...
  2  | 
  3  | test('Verify Login Page URL', async ({ page }) => {
  4  | 
