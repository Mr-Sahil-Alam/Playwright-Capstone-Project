...
- Name: authentication\signupPageHeading.spec.js >> Verify Signup Page Heading
- Location: tests\authentication\signupPageHeading.spec.js:3:1
...
```ts
  ...
  2  | 
  3  | test('Verify Signup Page Heading', async ({ page }) => {
  4  | 
