...
- Name: payment\paymentCartPageVisible.spec.js >> Verify Cart Page Visible
- Location: tests\payment\paymentCartPageVisible.spec.js:3:1
...
```ts
  ...
  2  | 
  3  | test('Verify Cart Page Visible', async ({ page }) => {
  4  | 
> 5  |     await page.goto(
     |                ^ Error: page.goto: net::ERR_INTERNET_DISCONNECTED at https://automationexercise.com/view_cart
